...
const page = () => {
  return (
    <div>
      <h1 className="mb-2 text-2xl">BMN 503: Operations Research</h1>
      <Image alt="image" src="/course/OR.png" height={400} width={400}></Image>
      <div className="mt-4 text-lg">
        <p className=" ">Welcome to the course BMN 503!</p>
